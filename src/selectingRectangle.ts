...
export class Rect {
    ...
    private rectStyler: (CanvasRenderingContext2D) => void;

    constructor(canvas: HTMLCanvasElement, anchorPoint: [number, number], rectStyler?: (CanvasRenderingContext2D) => void) {
        ...
        this.rectStyler = rectStyler || this.defaultRectStyler;
    }
    ...
    redraw(mousePosition: [number, number]) {
        ...
        this.remove();
        this.rectStyler(this.rectContext);
